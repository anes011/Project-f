        ...
        <ScrollView showsHorizontalScrollIndicator={false} horizontal style={[{marginTop: 10}]}>
            <Pressable style={[{alignItems: 'center'}, {gap: 10}, {marginRight: 20}]}>
                <View style={[{height: 90}, {width: 90}, {borderRadius: 20}, {justifyContent: 'center'}, {alignItems: 'center'}, {backgroundColor: 'rgba(0, 0, 0, .1)'}]}>
                    <Image style={[{height: '60%'}, {width: '60%'}]} source={require('../assets/Images&logos/Hamburger.png')} />
                </View>
            ...
            <Pressable style={[{alignItems: 'center'}, {gap: 10}, {marginRight: 20}]}>
                <View style={[{height: 90}, {width: 90}, {borderRadius: 20}, {justifyContent: 'center'}, {alignItems: 'center'}, {backgroundColor: 'rgba(0, 0, 0, .1)'}]}>
                    <Image style={[{height: '60%'}, {width: '60%'}]} source={require('../assets/Images&logos/Pizza.png')} />
                </View>
            ...
            <Pressable style={[{alignItems: 'center'}, {gap: 10}, {marginRight: 20}]}>
                <View style={[{height: 90}, {width: 90}, {borderRadius: 20}, {justifyContent: 'center'}, {alignItems: 'center'}, {backgroundColor: 'rgba(0, 0, 0, .1)'}]}>
                    <Image style={[{height: '60%'}, {width: '60%'}]} source={require('../assets/Images&logos/Taco.png')} />
                </View>
            ...
            <Pressable style={[{alignItems: 'center'}, {gap: 10}, {marginRight: 20}]}>
                <View style={[{height: 90}, {width: 90}, {borderRadius: 20}, {justifyContent: 'center'}, {alignItems: 'center'}, {backgroundColor: 'rgba(0, 0, 0, .1)'}]}>
                    <Image style={[{height: '60%'}, {width: '60%'}]} source={require('../assets/Images&logos/Chicken.png')} />
                </View>
            ...
            <Pressable style={[{alignItems: 'center'}, {gap: 10}, {marginRight: 20}]}>
                <View style={[{height: 90}, {width: 90}, {borderRadius: 20}, {justifyContent: 'center'}, {alignItems: 'center'}, {backgroundColor: 'rgba(0, 0, 0, .1)'}]}>
                    <Image style={[{height: '60%'}, {width: '60%'}]} source={require('../assets/Images&logos/Dessert.png')} />
                </View>
            ...
            <Pressable style={[{alignItems: 'center'}, {gap: 10}, {marginRight: 20}]}>
                <View style={[{height: 90}, {width: 90}, {borderRadius: 20}, {justifyContent: 'center'}, {alignItems: 'center'}, {backgroundColor: 'rgba(0, 0, 0, .1)'}]}>
                    <Image style={[{height: '60%'}, {width: '60%'}]} source={require('../assets/Images&logos/Drinks.png')} />
                </View>
            ...
            <Pressable style={[{alignItems: 'center'}, {gap: 10}, {marginRight: 20}]}>
                <View style={[{height: 90}, {width: 90}, {borderRadius: 20}, {justifyContent: 'center'}, {alignItems: 'center'}, {backgroundColor: 'rgba(0, 0, 0, .1)'}]}>
                    <Image style={[{height: '60%'}, {width: '60%'}]} source={require('../assets/Images&logos/Groceries.png')} />
                </View>
